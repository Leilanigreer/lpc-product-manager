...
--
-- Name: ProductDataLPC_amannId_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "ProductDataLPC_amannId_idx" ON public."ProductDataLPC" USING btree ("amannId");
...
--
-- Name: ProductDataLPC_quiltedLeatherColorId_idx; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX "ProductDataLPC_quiltedLeatherColorId_idx" ON public."ProductDataLPC" USING btree ("quiltedLeatherColorId");
...
ALTER TABLE ONLY public."IsacordNumber"
    ADD CONSTRAINT "IsacordNumber_threadId_fkey" FOREIGN KEY ("threadId") REFERENCES public."EmbroideryThread"(id) ON UPDATE CASCADE ON DELETE RESTRICT;


--
-- Name: ProductDataLPC ProductDataLPC_amannId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."ProductDataLPC"
    ADD CONSTRAINT "ProductDataLPC_amannId_fkey" FOREIGN KEY ("amannId") REFERENCES public."AmannNumber"(id) ON UPDATE CASCADE ON DELETE SET NULL;
...
ALTER TABLE ONLY public."ProductDataLPC"
    ADD CONSTRAINT "ProductDataLPC_isacordId_fkey" FOREIGN KEY ("isacordId") REFERENCES public."IsacordNumber"(id) ON UPDATE CASCADE ON DELETE RESTRICT;
...
--
-- Name: ProductDataLPC ProductDataLPC_quiltedLeatherColorId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public."ProductDataLPC"
    ADD CONSTRAINT "ProductDataLPC_quiltedLeatherColorId_fkey" FOREIGN KEY ("quiltedLeatherColorId") REFERENCES public."LeatherColor"(id) ON UPDATE CASCADE ON DELETE SET NULL;
