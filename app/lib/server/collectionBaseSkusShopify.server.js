 ...
 * `fetchCollectionBaseSkusForVersioning`). Vendor filtering is not applied here: LPC collections
 * only contain LPC products; vendor scoping stays on store-wide tools (e.g. Sync base SKUs scan).
 */
 ...
 * @returns {Promise<Array<{ baseSKU: string, collection: { shopifyAdminGid: string, value: string } }>>}
 */
