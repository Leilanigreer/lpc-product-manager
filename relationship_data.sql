-- First create indexes if they don't exist
CREATE INDEX IF NOT EXISTS "_EmbroideryThreadToTag_B_index" ON public."_EmbroideryThreadToTag"("B");
CREATE INDEX IF NOT EXISTS "_LeatherColorToTag_B_index" ON public."_LeatherColorToTag"("B");

-- Then import the relationship data
